...
{
    public partial class fSendPrivateMessages : Form
    {
        ...
        public fSendPrivateMessages(IActionsService actionsService, string scriptId)
        {
            InitializeComponent();
        ...
        private void fCreateChannels_load(object sender, EventArgs e)
        {
            try
            {
                ...
                nudNembersFrom.Value = jsonHelper.GetIntType("nudNembersFrom", 10);
                nudNembersTo.Value = jsonHelper.GetIntType("nudNembersTo", 30);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            json.AddValue("nudNembersFrom", nudNembersFrom.Value);
            json.AddValue("nudNembersTo", nudNembersTo.Value);
